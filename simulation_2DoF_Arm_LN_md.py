...
##################################################################
    ...
    cell_params_lsm = {  'cm'        : 30*nF,  # Capacitance of the membrane 
                       ...
                       'i_noise'   : 1.0*nA    # Used in Joshi/Maass 2005: mean 0 and SD=1nA
                    }
...
#                                                                         cell_params_lsm['tau_refrac_I']))
    ...
    pop_lsm.i_offset=sim_rs.uniform(13.5,14.5, Number_of_neurons_lsm)*nA
    pop_lsm.i_offset=pop_lsm.i_offset/1.05 # This adjust makes the liquid stop spiking without any input.
    ...
    pop_lsm.v=sim_rs.uniform(13.5,14.9, Number_of_neurons_lsm)*mV
